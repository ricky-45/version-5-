...
//        String[] nameMapping= {"candidateId","candidateName","age",};
        ...
        File file=new File("C:\\Users\\w127375\\OneDrive - Worldline\\Documents\\"+searchObj.filterValue+"_"+searchObj.inputData+".csv");
...
//        String[] nameMapping= {"candidateId","candidateName","age",};
        ...
        File file=new File("C:\\Users\\w127375\\OneDrive - Worldline\\Documents\\"+"report.csv");
        String csvString=CDL.toString(docs);
        FileUtils.writeStringToFile(file,csvString,Charset.defaultCharset());
