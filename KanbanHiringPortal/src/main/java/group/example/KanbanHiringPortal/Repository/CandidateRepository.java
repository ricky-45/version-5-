...
public interface CandidateRepository extends JpaRepository<Candidate,String>{
	...
	public List<Candidate> findMonthlyData(@Param("month") Integer inputValue);
	...
	@Query(value="Select c from Candidate c where average(timestamp(c.date,c.duedate))=:average")
	public List<Candidate> findAverageData(@Param("average") String inputValue1);
...
//	
//	public List<Candidate> findLocationData(String inputValue);
